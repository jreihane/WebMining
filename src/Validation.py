...
def cross_validation(rows, size, classes, K, csv_file, headers):
...
#         else:
        ...
        print '\n***************************** FINAL RESULTS in k = ' + str(k) + ' *****************************************************************'
        test_precision = calc_precision_recall(test_data, classes)
        
#         print '***************************** FINAL RESULTS in k = ' + str(k) + ' *****************************************************************'
#         print 'Precision: ' + str(test_precision[0]) + '\nRecall: ' + str(test_precision[1])
#         print '**********************************************************************************************************************\n'
